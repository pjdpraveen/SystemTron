...
canvas_size = 700
canvas = tkinter.Canvas(bg="black", width=canvas_size, height=canvas_size)
canvas.pack()
...
def draw(elements):
    ...
    elements[0] = text(canvas_size / 2, canvas_size / 2 + 80, digital_time, "#298F41")

    # Hour hand
    x, y = calculate((360 / 12) * tm[3] + (360 / 12 / 60) * tm[4] - 90, radius - 90)
    elements[1] = line_from_center(x, y, 12, "#f8f8ff")
